...
namespace APIProyectoSC_601
{
    ...
    public partial class db_aa61bd_impomyuEntities : DbContext
    {
        public db_aa61bd_impomyuEntities()
            : base("name=db_aa61bd_impomyuEntities")
        {
        }
        ...
        public virtual ObjectResult<Nullable<int>> ObtenerTemporal(string correo)
        {
            var correoParameter = correo != null ?
                new ObjectParameter("Correo", correo) :
                new ObjectParameter("Correo", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("ObtenerTemporal", correoParameter);
        }
